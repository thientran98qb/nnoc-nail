        ...
        <div class="relative z-20 flex items-center">
            <div class="container relative flex flex-col items-center justify-between px-6 py-4 mx-auto">
                <div class="flex flex-col">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkwguTM_CAr_kxZZko8PINGn1sKdaoes_Aqg&usqp=CAU" class="mx-auto rounded-full w-28"/>
                    ...
                    <div class="flex items-center justify-center mt-4">
                        <a href="#" class="px-4 py-2 my-2 text-gray-800 uppercase bg-transparent border-2 border-gray-800 md:mt-16 dark:text-gray-800 dark:bg-white hover:dark:bg-gray-100  hover:bg-gray-800 hover:text-white text-md">
                            CONNECT WITH ME
                        </a>
                    </div>
                </div>
